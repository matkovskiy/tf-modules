...
output "az_ngw_public_ip" {
  # No ellipsis needed since this module makes either public or private subnets. See the TF 0.15 one function
  value       = { for az, m in local.output_map : az => m.ngw_public_ip }
  description = "Map of AZ names to NAT Gateway Public_ip (only for public subnets)"
}
