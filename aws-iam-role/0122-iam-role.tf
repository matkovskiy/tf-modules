...
module "aggregated_assume_policy" {
  source           = "git::https://github.com/matkovskiy/tf-modules.git//aws-iam-policy-document-aggregator?ref=tags/0.0.28"
...
module "aggregated_policy" {
  source           = "git:github.com/matkovskiy/tf-modules.git//aws-iam-policy-document-aggregator?ref=tags/0.0.28"
