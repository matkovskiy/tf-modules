resource "aws_s3_bucket" "default" {
  ...
  bucket        = length(var.bucket_custom_name) > 0 ? var.bucket_custom_name : module.this.id
...
module "s3_user" {
  source       = "git::https://github.com/matkovskiy/tf-modules.git//aws-iam-s3-user?ref=tags/0.0.21"
